    ...
    describe('Band Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/bands';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Band', () => {
                service.create(new Band(null)).subscribe(received => {
            ...
            it('should update a Band', () => {
                service.update(new Band(123)).subscribe(received => {
