    ...
    describe('Musician Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/musicians';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Musician', () => {
                service.create(new Musician(null)).subscribe(received => {
            ...
            it('should update a Musician', () => {
                service.update(new Musician(123)).subscribe(received => {
            ...
            it('should return a list of Musician', () => {
                service.query(null).subscribe(received => {
                    expect(received.body[0].id).toEqual(123);
                });

                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new Musician(123)]);
            });
