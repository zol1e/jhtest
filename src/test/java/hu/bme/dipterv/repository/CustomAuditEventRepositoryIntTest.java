...
import hu.bme.dipterv.config.audit.AuditEventConverter;
import hu.bme.dipterv.domain.PersistentAuditEvent;
...
import static hu.bme.dipterv.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
